...
class BannerList extends TPage
{
    ...
    private static $formName = 'form_search_Banner';
    private $showMethods = ['onReload', 'onSearch', 'onRefresh', 'onClearFilters'];
    private static $formTitle = '<i class="fas fa-chalkboard fa-fw nav-icon"></i> Banners';
    private $limit = 10;
    ...
    public function __construct()
    {
        ...
        $column_image  = new TDataGridColumn('imagem', 'Banner', 'center');
        ...
        $column_image->setTransformer( function($value, $object, $row) {
        ...
        $action_edit   = new TDataGridAction(['BannerForm', 'onEdit'],   ['key' => '{id}'] );
        ...
        $button_novo->setAction(new TAction(['BannerForm', 'onEdit']), "Cadastrar");
