...
class PedidoEntradaList extends TPage
{
    ...
    private static $formName = 'form_search_PedidoEntrada';
    private $showMethods = ['onReload', 'onSearch', 'onRefresh', 'onClearFilters'];
    private static $formTitle = '<i class="fas fa-clipboard-list fa-fw nav-icon"></i> Pedidos de Entrada';
    private $limit = 10;
    ...
    public function __construct()
    {
        ...
        $column_pessoa           = new TDataGridColumn('{pessoa->nome}', 'Fornecedor', 'left');
        ...
        $action_edit   = new TDataGridAction(['PedidoEntradaForm', 'onEdit'],   ['key' => '{id}', 'pessoa_id' => '{pessoa_id}'] );
        ...
        $button_novo->setAction(new TAction(['PedidoEntradaForm', 'onEdit']), "Cadastrar");
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            $criteria->add(new TFilter('tipo_pedido', '=', "E"));
