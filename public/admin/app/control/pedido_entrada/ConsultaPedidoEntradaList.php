...
class ConsultaPedidoEntradaList extends TPage
{
    ...
    private static $formName = 'form_search_ConsultaPedidoEntrada';
    private $showMethods = ['onReload', 'onSearch', 'onRefresh', 'onClearFilters'];
    private static $formTitle = '<i class="fas fa-search fa-fw nav-icon"></i> Consulta de Pedidos de Entrada';
    private $limit = 10;
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            $criteria2->add(new TFilter('tipo_pedido', '=', "E"));
