...
class FabricanteList extends TPage
{
    ...
    private static $formName = 'form_search_Fabricante';
    private $showMethods = ['onReload', 'onSearch', 'onRefresh', 'onClearFilters'];
    private static $formTitle = '<i class="fas fa-industry fa-fw nav-icon"></i> Fabricantes';
    private $limit = 10;
    ...
    public function __construct()
    {
        ...
        $column_nome         = new TDataGridColumn('nome', 'Fabricante', 'left');
        $column_logo         = new TDataGridColumn('logo', 'Logo', 'center');
        $column_preview_site = new TDataGridColumn('preview_site', 'Preview Site', 'center');

        $this->datagrid->addColumn( $column_id );
        $this->datagrid->addColumn( $column_nome );
        $this->datagrid->addColumn( $column_preview_site );
        $this->datagrid->addColumn( $column_logo );

        $column_preview_site->setTransformer( function($value, $object, $row) {
        ...
        $action_edit   = new TDataGridAction(['FabricanteForm', 'onEdit'],   ['key' => '{id}'] );
        ...
        $button_novo->setAction(new TAction(['FabricanteForm', 'onEdit']), "Cadastrar");
