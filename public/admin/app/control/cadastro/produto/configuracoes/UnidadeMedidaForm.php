...
class UnidadeMedidaForm extends TPage
{
    ...
    private static $activeRecord = 'UnidadeMedida';
    private static $primaryKey = 'id';
    private static $formName = 'form_UnidadeMedida';
    private $showMethods = ['onEdit', 'onSave', 'onDelete'];
    private static $formTitle = '<i class="fas fa-tape fa-fw nav-icon"></i> Unidade de Medida';
    ...
    function __construct()
    {
        ...
        $row1 = $this->form->addFields(
            [ new TLabel('Unidade', 'red'), $nome       ],
            [ new TLabel('Sigla', 'red'),   $sigla      ],
            [ new TLabel('ID'),             $id         ],
        );
        ...
        try
        {
            if (isset($param['key']))
            {
                ...
                if ($this::isMobile())
                {
                    ...
                    $this->dropdown_acoes->addAction('Voltar', new TAction(['UnidadeMedidaList', 'onReload']), 'fa:arrow-left black');
                }else{
                    ...
                    $this->form->addHeaderAction('Voltar', new TAction(['UnidadeMedidaList', 'onReload']), 'fa:arrow-left black');
                }
            }
            else
            {
    ...
    public function onDelete($param = null)
    {
        if (isset($param['delete']) && $param['delete'] == 1) {
            try {
                ...
                new TMessage('info', 'Registro excluido com sucesso!', new TAction(['UnidadeMedidaList', 'onReload']), 'Sucesso');
            } catch (Exception $e) {
