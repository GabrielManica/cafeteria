...
class UnidadeMedidaList extends TPage
{
    ...
    private static $formName = 'form_search_UnidadeMedida';
    private $showMethods = ['onReload', 'onSearch', 'onRefresh', 'onClearFilters'];
    private static $formTitle = '<i class="fas fa-tape fa-fw nav-icon"></i> Unidades de Medida';
    private $limit = 10;
    ...
    public function __construct()
    {
        ...
        $column_nome = new TDataGridColumn('nome', 'Unidade de Medida', 'left');
        ...
        $action_edit   = new TDataGridAction(['UnidadeMedidaForm', 'onEdit'],   ['key' => '{id}'] );
        ...
        $button_novo->setAction(new TAction(['UnidadeMedidaForm', 'onEdit']), "Cadastrar");
