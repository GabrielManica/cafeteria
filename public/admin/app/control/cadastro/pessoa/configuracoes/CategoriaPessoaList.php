...
class CategoriaPessoaList extends TPage
{
    ...
    private static $formName = 'form_search_CategoriaPessoa';
    private $showMethods = ['onReload', 'onSearch', 'onRefresh', 'onClearFilters'];
    private static $formTitle = '<i class="far fa-check-square fa-fw nav-icon"></i> Categorias Pessoa';
    private $limit = 10;
    ...
    public function __construct()
    {
        ...
        $column_nome = new TDataGridColumn('nome', 'Categoria', 'left', '95%');
        ...
        $action_edit   = new TDataGridAction(['CategoriaPessoaForm', 'onEdit'],   ['key' => '{id}'] );
        ...
        $button_novo->setAction(new TAction(['CategoriaPessoaForm', 'onEdit']), "Cadastrar");
