...
class GrupoPessoaList extends TPage
{
    ...
    private static $formName = 'form_search_GrupoPessoa';
    private $showMethods = ['onReload', 'onSearch', 'onRefresh', 'onClearFilters'];
    private static $formTitle = '<i class="fas fa-users fa-fw nav-icon"></i> Grupos Pessoa';
    private $limit = 10;
    ...
    public function __construct()
    {
        ...
        $column_nome = new TDataGridColumn('nome', 'Grupo', 'left', '95%');
