...
class EnderecoTipoList extends TPage
{
    ...
    private static $formName = 'form_search_EnderecoTipo';
    private $showMethods = ['onReload', 'onSearch', 'onRefresh', 'onClearFilters'];
    private static $formTitle = '<i class="far fa-check-square fa-fw nav-icon"></i> Tipos de Endereço';
    private $limit = 10;

    use Util\Trait\Gerais;
    use Util\Trait\ListTrait;
    use Util\Trait\ExportTrait;
    ...
    public function __construct()
    {
        ...
        $column_nome = new TDataGridColumn('nome', 'Tipo', 'left', '95%');
        ...
        $action_edit   = new TDataGridAction(['EnderecoTipoForm', 'onEdit'],   ['key' => '{id}'] );
        ...
        $button_novo->setAction(new TAction(['EnderecoTipoForm', 'onEdit']), "Cadastrar");
