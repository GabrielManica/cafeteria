...
class PedidoSaidaList extends TPage
{
    ...
    private static $formName = 'form_search_PedidoSaida';
    private $showMethods = ['onReload', 'onSearch', 'onRefresh', 'onClearFilters'];
    private static $formTitle = '<i class="fas fa-clipboard-list fa-fw nav-icon"></i> Pedidos de Saída';
    private $limit = 10;
